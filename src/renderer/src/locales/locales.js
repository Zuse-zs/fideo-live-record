export default {
  en: {
    translation: {
      ...
      web_control_setting: {
        ...
        web_control_path: 'Access Path',
        web_control_path_required: 'Access path cannot be empty',
        web_control_path_placeholder: 'Enter a custom path or generate one automatically',
        generate_path: 'Generate',
        enable_web_control: 'Enable Web Control',
        enable_web_control_tooltip: 'Enable to control recording via mobile phone',
        generate_path_success: 'Path generated successfully',
        generate_path_success_desc: 'A new access path has been generated',
  ...
  cn: {
    translation: {
      ...
      web_control_setting: {
        title: '网页操作配置',
        web_control_path: '访问路径',
        web_control_path_required: '访问路径不能为空',
        web_control_path_placeholder: '输入自定义路径或自动生成',
        generate_path: '生成',
        enable_web_control: '开启网页访问功能',
        enable_web_control_tooltip: '启用后可在手机通过网页操作录制',
        generate_path_success: '路径生成成功',
        generate_path_success_desc: '已生成新的访问路径',
